...
export const resourceData: ResourceCategory[] = [
  {
    ...
    resources: [
      {
        name: 'JavaScript 教程',
        desc: '通俗易懂的 JavaScript 教程',
        logo: 'https://wangdoc.com/javascript/assets/icons/favicon-96x96.png',
      ...
      {
        name: 'JavaScript 30',
        desc: '使用原生JavaScript在30天内完成30个项目',
        logo: 'https://javascript30.com/images/favion-JS3.png',
        href: 'https://javascript30.com/',
      },
      {
        name: 'Node.js 学习指南',
        desc: '系统的 Node.js 学习教程和笔记系统整理',
        logo: 'https://blog.poetries.top/node-learning-notes/logo.png',
        href: 'https://blog.poetries.top/node-learning-notes/',
      },
      {
        name: 'JS 代码规范',
        desc: '优秀的 JS代码规范',
  ...
  },
  {
    ...
    resources: [
      ...
      },
      {
        ...
        logo: 'https://about.gitea.cn/favicon.svg',
        href: 'https://gitea.io/',
        tags: ['代码托管'],
      },
      {
  ...
  },
  {
    ...
    resources: [
      ...
      {
        name: 'Cloudflare',
        desc: '使用 Workers 和 Pages 构建和部署无服务器功能、站点和全栈应用程序。',
        logo: 'https://dash.cloudflare.com/favicon-196x196.png',
